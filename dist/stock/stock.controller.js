...
__decorate([
    (0, common_1.Get)(':almId/:prodId'),
    __param(0, (0, common_1.Param)('almId')),
...
__decorate([
    (0, common_1.Patch)(':almId/:prodId'),
    __param(0, (0, common_1.Param)('almId')),
    __param(1, (0, common_1.Param)('prodId')),
    __param(2, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number, Number, update_stock_dto_1.UpdateStockDto]),
    __metadata("design:returntype", void 0)
], StockController.prototype, "update", null);
__decorate([
    (0, common_1.Delete)(':almId/:prodId'),
    __param(0, (0, common_1.Param)('almId')),
    __param(1, (0, common_1.Param)('prodId')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number, Number]),
